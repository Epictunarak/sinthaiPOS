...
#
# คำว่า "แพ็ค" สะกดไม่เหมือนกันทุกแถวในชีต — เจอทั้ง "แพ็ค" (33 แถว) และ "แพ็ก" (1 แถว)
# ถ้ารองรับแค่แบบเดียว จำนวนต่อแพ็คของแถวที่สะกดอีกแบบจะถูกตั้งเป็น 1 เงียบๆ
# แล้วต้นทุนต่อหน่วยกับกำไรของสินค้าตัวนั้นจะผิดทั้งหมดโดยไม่มีอะไรเตือน
PACK_PATTERNS = [
    r"(?:แพ็[คก]|แพค|pack)\s*(\d+)",      # "แพ็ค 12", "แพ็ก 12", "Pack 6"
