...
ใช้ตัวจำลอง Sheets API ใน `tests/apps-script/harness.mjs` ครอบคลุมการสร้างชีต การรันซ้ำ
การเติมคอลัมน์ที่ขาดโดยไม่ย้ายของเดิม และทุกกรณีที่ `checkSetup` ต้องจับได้
