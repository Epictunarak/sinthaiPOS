...
ใช้ตัวจำลอง Sheets API ใน `tests/apps-script/harness.mjs` ครอบคลุม 49 เคส:
...
- **ActivityLogs** — ขาย/ยกเลิก/ตรวจนับที่มีส่วนต่าง/บันทึกบาร์โค้ด ต้องลง log
  ส่วนตรวจนับที่จำนวนไม่ต่างจากเดิมต้องไม่ลง log ซ้ำ
- **search** และ **reportRange** — เตรียมไว้ให้ต่อเข้าแอปในอนาคต (ค้นรวมข้าม Products/Sales
  และรายงานเลือกช่วงวันที่ได้ ไม่ใช่แค่วันเดียว) ยังไม่มี UI แต่ backend ทดสอบพร้อมใช้แล้ว
